...
PLoop(function(_ENV)
    ...
    class "System.Threading" (function(_ENV)
        ...
        class "__Async__"               (function(_ENV)
            ...
            export                      {
                _nrmlwrap               = Platform.RECORD_ASYNC_FUNC_WRAP and Toolset.newtable(true, true) or nil,
                _safewrap               = Platform.RECORD_ASYNC_FUNC_WRAP and Toolset.newtable(true, true) or nil,
            ...
            if Platform.RECORD_ASYNC_FUNC_WRAP then
                -----------------------------------------------------------
                --                     static method                     --
                -----------------------------------------------------------
                --- Gets the original function
                -- @param   func        the function generated by __Async__
                -- @return  original    the original function
                -- @return  safe        safe thread mode
                __Static__()
                function GetOriginal(func)
                    if _safewrap[func] then return _safewrap[func], true end
                    if _nrmlwrap[func] then return _nrmlwrap[func], false end
                end
                ...
                function InitDefinition(self, target, targettype, definition, owner, name, stack)
                    if self.SafeMode then
                        local wrap      = safewrap(definition)
                        _safewrap[wrap] = definition
                        return wrap
                    else
                        local wrap      = wraptarget(definition)
                        _nrmlwrap[wrap] = definition
                        return wrap
                    end
                end
            else
        ...
        class "__Iterator__"            (function(_ENV)
            ...
            export {
                _iterwrap               = Platform.RECORD_ASYNC_FUNC_WRAP and Toolset.newtable(true, true) or nil,
            ...
            if Platform.RECORD_ASYNC_FUNC_WRAP then
                ...
                -----------------------------------------------------------
                --- Gets the original function
                -- @param   func        the function generated by __Iterator__
                -- @return  original    the original function
                __Static__()
                function GetOriginal(func)  return _iterwrap[func] end
