...
PLoop(function(_ENV)
    ...
    __Sealed__() interface "ICache" (function(_ENV)
        ...
        __Abstract__() function Incr(self, key, increment) end

        --- Decrease the value by 1 or given decrement, return the final result
        __Abstract__() function Decr(self, key, decrement) end
    ...
    __Sealed__() interface "IHashCache" (function(_ENV)
        ...
        __Abstract__() function SetExpireTime(self, hash, expiretime) end

        --- Whether the hash key existed in the cache
        __Abstract__() function Exist(self, hash) end

        --- Delete a hash key from the cache
        __Abstract__() function Delete(self, hash) end

        --- Try sets the hash field value if not existed, return true if success
        __Abstract__() function HTrySet(self, hash, field, value) end

        --- Sets the hash field value to the cache
        __Abstract__() function HSet(self, hash, field, value) end

        --- Gets the hash field value
        __Abstract__() function HGet(self, hash, field, class) end

        --- Increase the field value by 1 or given increment, return the final result
        __Abstract__() function HIncr(self, hash, field, increment) end

        --- Decrease the field value by 1 or given decrement, return the final result
        __Abstract__() function HDecr(self, hash, field, decrement) end

        --- Whether the field existed in the hash cache
        __Abstract__() function HExist(self, hash, field) end

        --- Delete a field from the hash cache
        __Abstract__() function HDelete(self, hash, field) end

        --- Return an iterator to fetch all field-value pairs in the hash cache
        __Abstract__() __Iterator__() function HPairs(self, hash, type) end
    end)
