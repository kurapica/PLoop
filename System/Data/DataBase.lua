...
PLoop(function(_ENV)
    ...
    interface "ISqlBuilder"             (function(_ENV)
        ...
        -- @return self
        __Abstract__()
        function Select(self, fields) return self end

        --- Gets the row count
        -- @return self
        __Abstract__()
        function Count(self) return self end

        --- Lock the query rows
        -- @return self
        __Abstract__()
        function Lock(self) return self end

        --- Sets the updating field-value map
        -- @param map       a map for field to value
        -- @return self
        __Abstract__()
        function Update(self, map) return self end

        --- Sets to delete data
        -- @return self
        __Abstract__()
        function Delete(self) return self end

        --- Insert the data
        -- @return self
        __Abstract__()
        function Insert(self, map) return self end
        ...
        -- @return self
        __Abstract__()
        function From(self, name, alias) return self end

        --- Set the conditions
        -- @param condition the query condition
        -- @return self
        __Abstract__()
        function Where(self, condition) return self end
        ...
        -- @return self
        __Abstract__()
        function OrderBy(self, field, desc) return self end

        -- Set the limit count
        -- @param count
        -- @return self
        __Abstract__()
        function Limit(self, count) return self end

        -- Set the offset
        -- @param offset
        -- @return self
        __Abstract__()
        function Offset(self, offset) return self end

        --- Generate the final sql
        -- @return sql
        __Abstract__()
        function ToSql(self) end
    end)
    ...
    interface "IDbConnection"           (function(_ENV)
        ...
        __Abstract__()
        property "State"                { type = ConnectionState, default = ConnectionState.Closed }
    ...
    interface "IDbTransaction"          (function(_ENV)
        ...
        __Abstract__()
        property "Connection"           { type = IDbConnection }

        --- The transaction isolation level
        __Abstract__()
        property "Isolation"            { type = TransactionIsolation, default = TransactionIsolation.REPEATABLE_READ }

        --- Whether the transaction is open
        __Final__()
        property "IsTransactionOpen"    { type = Boolean }
    ...
    __Sealed__()
    class "__DataView__"                (function(_ENV)
    ...
    __Sealed__()
    interface "IDataContext"            (function (_ENV)
        extend "IAutoClose"
    ...
    __Sealed__()
    interface "IDataEntity"             (function (_ENV)
    ...
    __Sealed__()
    class "__DataObject__"              (function(_ENV)
    ...
    __Sealed__()
    class "__DataContext__"             (function(_ENV)
