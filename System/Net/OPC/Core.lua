...
PLoop(function(_ENV)
    ...
    __Sealed__() class "__Node__" (function(_ENV)
        ...
        __Static__() function HasNodeInfo(target, name)
            if name then
    ...
    class "AddressSpace"        (function(_ENV)
        ...
        function RegisterNode(self, node)
            ...
            if self.View then   self.View.ViewVersion   = self.View.ViewVersion + 1 end
        end
        ...
        property "ModellingRules" {
            get                 = function(self, rule)
                return self.AddressSpace.__ModellingRules[rule]
            end
        }
