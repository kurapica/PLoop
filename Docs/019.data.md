...
Where               |condition: String, ... : Any * 0         |Prepare the query with the condition string and parameters, the string should use the data field name instead of the property name since the system won't replace them to field name
