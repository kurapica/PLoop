...
* The controller class must inherit `System.Web.
...
In actual website construction, we provide a lot of processing for internal requests only, we usually need to use `if context. , which directly returns 404, rejects the request.
